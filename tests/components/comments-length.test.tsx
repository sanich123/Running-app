...
import CommentsLength from '../../components/comments-length/comments-length';
import { COMMENTS_ENDING, COMMENTS_LENGTH_TEST_ID, getWordEnding } from '../../components/comments-length/const';
