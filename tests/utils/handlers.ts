...
export const handlers = [
  ...
  rest.get(`${BASE_URL}/user/someUserId/profile`, getProfileSuccess),
  ...
  rest.get(`${BASE_URL}/user/someUserIdWithAnError/profile`, getProfileFailure),
  rest.get(`${BASE_URL}/user/someUserIdWithoutPhoto/profile`, getProfileWithoutPhoto),
