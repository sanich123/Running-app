...
describe('Activity start btn', () => {
  it('should correctly renders in english', () => {
    ...
    renderWithProviders(<ActivityStartBtn isReadyToRecordLocation />, { store: mockStore });
  ...
  it('should correctly renders finish in russian', () => {
    ...
    mockStore.dispatch(setActivityStatus(STATUSES.paused));
    renderWithProviders(<ActivityStartBtn isReadyToRecordLocation={false} />, { store: mockStore });
  });
